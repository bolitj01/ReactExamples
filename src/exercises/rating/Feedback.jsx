...
export default function Feedback({ rating, onSubmit: parentOnSubmit }) {
  ...
  return (
    <div className={styles.thanks}>🎉 Thanks for the {rating}-star rating!</div>
  );

  return (
    <div className={styles.confirm}>✅ Thanks—your feedback was recorded.</div>
  );

  return (
    <form onSubmit={handleSubmit} className={styles.formFull}>
      <label className={styles.label}>
        Could you tell us what we can improve?
      </label>
      <textarea
        value={feedback}
      ...
      <div className={styles.alignRight}>
        <button
          ...
          className={`${styles.submit} ${
            feedback.trim() ? styles.submitEnabled : styles.submitDisabled
          }`}
        >
          Submit
        </button>
